      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 px-4">
            ...
            <h3 className="font-display text-2xl md:text-3xl text-foreground text-center">No blind tastings yet</h3>
            <p className="mt-4 text-muted-foreground text-center max-w-md text-lg">
              Evaluate whiskeys without seeing their labels. Perfect for unbiased comparisons.
            </p>
                ...
                {availableWhiskeys.map((whiskey) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="font-medium">{formatWhiskeyName(whiskey.name)}</div>
