...
export function RickAtmosphere({ userName, sessionCount, lastSessionToday }: RickAtmosphereProps) {
  ...
  return (
    <section className="relative overflow-hidden pt-10 pb-8 px-5">
      {/* Ambient radial glow */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="rick-atmosphere-glow w-[300px] h-[300px] rounded-full" />
      </div>

      <div className="relative flex flex-col items-center text-center">
        {/* Glencairn glass — mini brand mark */}
        <svg
          width="48"
          height="48"
          viewBox="58 36 84 114"
          fill="none"
          className="text-primary mb-6 opacity-70"
        >
        ...
        {/* Greeting */}
        <p className="font-display text-lg text-foreground/80 max-w-xs leading-relaxed">
          {greeting}
        </p>
      </div>
    </section>
